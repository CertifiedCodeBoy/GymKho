...
const Login = () => {
  ...
  return (
    <div className="container mx-auto p-4 overflow-hidden flex flex-col lg:flex-row-reverse justify-center items-center h-screen">
      {/* back button */}
      <div
        className="
          absolute
      ...
      >
        ...
        <div
          ...
          "
        >
          <img src="/src/assets/signUp/Login-amico 1.svg" />
        </div>
      </div>
      {/* border */}
      <div className="hidden lg:block border-r border-gray-400 h-[550px] mx-16"></div>
      {/* form */}
      <div
        className="
          p-4
